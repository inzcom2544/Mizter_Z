...
class Ui_page(object):
    ...
    def retranslateUi(self, page):
        ...
        self.labelSic.setText(_translate("page", "<html><head/><body><p align=\"center\"><span style=\" font-size:36pt; font-weight:600; color:#0000ff;\">SicBo</span></p><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; color:#0000ff;\">Gamble by KMITL</span></p></body></html>"))
